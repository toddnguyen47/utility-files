...
insulate("Insulated Interface Test | ", function()
    ...
    setup(function() sampleInterface = SampleInterface:new() end)

    test("Should throw an error",
         function() assert.has_error(sampleInterface.returnOne) end)

    test("Should NOT throw an error",
         function() assert.has_no.errors(sampleInterface.returnTwo) end)
