...
function HashSet:contains(elem) return self.storage[elem] ~= nil end

function HashSet:isEmpty() return self.sizeOfStorage == 0 end
...
function HashSet:size() return self.sizeOfStorage end
