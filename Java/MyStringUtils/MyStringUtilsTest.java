...
public class MyStringUtilsTest {
    ...
    private static final String LOREM_IPSUM =
            "           Lorem    ipsum dolor sit amet,     consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Consectetur adipiscing elit duis tristique. Ridiculus mus mauris vitae ultricies leo. Urna nec tincidunt praesent semper feugiat. Sit amet volutpat consequat mauris nunc. Tristique nulla aliquet enim tortor at. Metus aliquam eleifend mi in nulla. Non blandit massa enim nec dui nunc mattis enim ut. Sit amet nulla facilisi morbi tempus iaculis urna. Eget gravida cum sociis natoque penatibus et magnis dis. Nulla facilisi etiam dignissim diam. Erat nam at lectus urna duis convallis convallis. Ultricies lacus sed turpis tincidunt id aliquet. A diam maecenas sed enim. Felis eget velit aliquet sagittis id consectetur purus ut. Tellus molestie nunc non blandit massa. In hendrerit gravida rutrum quisque. Rutrum quisque non tellus orci ac. Viverra aliquet eget sit amet. Tristique et egestas quis ipsum suspendisse.\n"
                    + "\n"
                    + "Elementum integer enim neque volutpat ac. Semper risus in hendrerit gravida rutrum quisque. Non diam phasellus vestibulum lorem. Vitae nunc sed velit dignissim sodales. Eros in cursus turpis massa tincidunt dui ut ornare lectus. Fames ac turpis egestas sed tempus urna et pharetra pharetra. Nisi quis eleifend quam adipiscing. Vulputate odio ut enim blandit volutpat. Vivamus arcu felis bibendum ut tristique. Lacus luctus accumsan tortor posuere. Nisl purus in mollis nunc sed id semper risus. Iaculis at erat pellentesque adipiscing commodo. Dolor sit amet consectetur adipiscing elit duis tristique sollicitudin. Vulputate enim nulla aliquet porttitor lacus. Ultricies mi quis hendrerit dolor magna eget. Consectetur lorem donec massa sapien faucibus. Neque egestas congue quisque egestas. Quis risus sed vulputate odio ut enim blandit. Amet volutpat consequat mauris nunc congue nisi vitae suscipit tellus.";
    ...
    public void test_GivenWhitespaceStringLessThanMaxWidth_When_ThenNoWhitespaceIsReturned() {
        ...
        Assert.assertThat(actualString, Matchers.equalTo(expectedString));
    }
    ...
    public void tset_GivenWhitespace_WhenReplacingWhitespace_ThenReturnWhitespaceOmitted() {
        final String input =
                "{" + "    \"item\": \"lich bane\"," + "    \"categories\": [\"ap\", \"movement speed\"]," + "    \"stats\": {"
                        + "        \"ap\": 80," + "        \"movement speed\": 15," + "        \"effect\": \"spellblade\"" + "    }" + "}";
